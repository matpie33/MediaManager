...
describe('RootComponent', () => {
  ...
  beforeEach(async () => {
    restServiceSpy = jasmine.createSpyObj(RestClientService.name, [RestClientService.prototype.getUserPermissions.name]);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RestClientService, useValue: restServiceSpy}
      ]
    }).compileComponents();
